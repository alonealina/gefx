...
<div class="header_margin_sp top_bg1_sp">
    <img src="{{ asset('img/logo_white.png') }}" class="top_logo_sp" alt="">
...
<div class="top_bg2_sp">
    ...
    <img src="{{ asset('img/top2_img2.png') }}" class="top2_img_sp2" alt="">
</div>

<div class="top_bg3_sp">
    <div class="top3_text">簡単即座の<br>新規口座開設手順</div>
    <div class="top3_img_list">
        <img src="{{ asset('img/hexa1.png') }}" class="top3_img_sp" alt="" style="margin-left: -77px;">
        <img src="{{ asset('img/hexa2.png') }}" class="top3_img_sp" alt="" style="margin:-165px 45px;">
        <img src="{{ asset('img/hexa3.png') }}" class="top3_img_sp" alt="" style="margin-left: -77px;">
        <img src="{{ asset('img/hexa4.png') }}" class="top3_img_sp" alt="" style="margin:-165px 45px;">
        <img src="{{ asset('img/hexa5.png') }}" class="top3_img_sp" alt="" style="margin-left: -77px;">
    </div>
</div>
